...
namespace RingdahlJonahHomework08
{
    class ReportCard
    {
        ...
        public ReportCard(int id, string studentName, int midtermGrade, int finalGrade)
        {
            ...
            midtermLetterGrade = GenerateLetterGrade(midtermGrade);
            finalLetterGrade = GenerateLetterGrade(finalLetterGrade);
        }
        #endregion
        ...
        public ReportCard(int id) //  id is autogenerated 
        {
            Id = id;

            studentName = StudentName();
            midtermGrade = QueryMiddleGrade();
            finalGrade = QueryFinalGrade();
        ...
        private int QueryFinalGrade() //Number that is passed determines what the function is to do with the method
        {
            int amount;
            bool test;
            string input;
        ...
        private char GenerateLetterGrade(int grade) // a case switch solution of finding the Letter Grade for a inputted grade
        {
            char letterGrade;
